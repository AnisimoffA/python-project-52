...
class Task(models.Model):
    creator = models.ForeignKey(CustomUsers, on_delete=models.RESTRICT, verbose_name="Создатель", related_name="creator")
    name = models.CharField(max_length=255, verbose_name="Название")
    description = models.TextField(blank=True, verbose_name="Описание")
    status = models.ForeignKey(Status, on_delete=models.RESTRICT, verbose_name="Статус")
    executor = models.ForeignKey(CustomUsers, blank=True, null=True, on_delete=models.RESTRICT, verbose_name="Исполнитель")
